...
class Persona(models.Model):
    ...
    Distrito = models.ForeignKey(Distrito, models.DO_NOTHING, db_column='cepk_distrito')
...
class CeMatricula(models.Model):
    ...
    Grado_Seccion = models.ForeignKey(CeDetGradsecc, models.DO_NOTHING, db_column='cepk_gradsec')
