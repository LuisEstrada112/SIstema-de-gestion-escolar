...
class PersonaForm(forms.ModelForm):
    class Meta:
        model = Persona
        fields = ('cepk_per','per_nombres','per_apellpat','per_apellmat','per_dni','per_telf','per_nomcalle','Distrito','per_email','per_fechnac')
        widgets = {
...
class MatriculaForm(forms.ModelForm):
    class Meta:
        ...
        opcEstad = [(x.cat_secundario,x.cat_descripcion) for x in listaEstad]
        opcEstad.sort()
        fields =('matr_fecha','matr_estado','matr_observacion','Grado_Seccion','matr_observacion','matr_edadalumno')
        widgets = {
            ...
            'Grado_Seccion': forms.Select(attrs={'class': 'form-control'}),
            'matr_observacion': forms.TextInput(attrs={'class': 'form-control'}),
...
class MantMatriculaForm(forms.ModelForm):
    class Meta:
        ...
        opcEstad = [(x.cat_secundario,x.cat_descripcion) for x in listaEstad]
        opcEstad.sort()
        fields =('matr_fecha','matr_observacion','Grado_Seccion','matr_observacion','matr_edadalumno',)
        widgets = {
            'matr_fecha': forms.DateInput(attrs={'type':'date'}),
            'matr_observacion': forms.TextInput(attrs={'class': 'form-control'}),
            'Grado_Seccion': forms.Select(attrs={'class': 'form-control'}),
